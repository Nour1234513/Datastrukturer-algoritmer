...
void experimentMedParameteroverforing(){
    ...
    /* TODO!!
       ...
       När man skickar data med referens eller pointer så skickar man adressen till deras data utan att göra ny kopia
       och när man skickar data utan referens och pointer så skickar man en kopia av data som finns i adressen,
       vilket betyder att man kan inte göra ändring i orginal data medan man kan bara göra ändring i kopian.
     */
}
